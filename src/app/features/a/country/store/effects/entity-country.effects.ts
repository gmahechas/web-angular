...
import * as fromReducers from '@web/app/features/a/country/store/reducers';
import * as fromSelectors from '@web/app/features/a/country/store/selectors';
import * as fromActions from '@web/app/features/a/country/store/actions';
