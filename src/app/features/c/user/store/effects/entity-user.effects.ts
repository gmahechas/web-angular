...
import * as fromReducers from '@web/app/features/c/user/store/reducers';
import * as fromSelectors from '@web/app/features/c/user/store/selectors';
import * as fromActions from '@web/app/features/c/user/store/actions';
