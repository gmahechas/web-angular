...
export const containers: any[] = [
  ...
  FormPageHourRangeComponent
];

export * from '@web/app/features/f/hour-range/containers/index-page-hour-range/index-page-hour-range.component';
export * from '@web/app/features/f/hour-range/containers/form-page-hour-range/form-page-hour-range.component';
