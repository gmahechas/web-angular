...
export const containers: any[] = [
  IndexPageDepartmentComponent,
  FormPageDepartmentComponent
];

export * from '@web/app/features/b/department/containers/index-page-department/index-page-department.component';
export * from '@web/app/features/b/department/containers/form-page-department/form-page-department.component';
