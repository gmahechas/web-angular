...
import * as fromReducers from '@web/app/features/b/estate/store/reducers';
import * as fromSelectors from '@web/app/features/b/estate/store/selectors';
import * as fromActions from '@web/app/features/b/estate/store/actions';

import * as fromModels from '@web/app/features/b/estate/models';

import { EstateService } from '@web/app/features/b/estate/services/estate.service';
