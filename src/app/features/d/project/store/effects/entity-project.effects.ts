...
import * as fromReducers from '@web/app/features/d/project/store/reducers';
import * as fromSelectors from '@web/app/features/d/project/store/selectors';
import * as fromActions from '@web/app/features/d/project/store/actions';
