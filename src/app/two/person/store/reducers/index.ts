...
import * as fromSearch from '@web/app/two/person/store/reducers/search-person.reducer';
import * as fromPagination from '@web/app/two/person/store/reducers/pagination-person.reducer';
